...
///@{
constexpr U16 N4_DIC_SZ = 0x1000; /**< default dictionary size             */
...
/// @def ENC16
/// @brief 2-byte write, prevent alignment issue (on 32-bit CPU) and preserve
/// Big-Endian encoding
/// @def GET16
/// @brief 2-byte read, prevent alignment issue (on 32-bit CPU) and preserve
/// Big-Endian encoding
///@{
